...
class NewSellInvoicePlans extends StatefulWidget {
  const NewSellInvoicePlans({
    Key? key,
  ...
  @override
  State<NewSellInvoicePlans> createState() => _NewSellInvoicePlansState();
}

class _NewSellInvoicePlansState extends State<NewSellInvoicePlans> {
        ...
        body: SafeArea(
          child: SingleChildScrollView(
            child: Padding(
              ...
              child: _productsSection(context),
            ),
          ),
        ),
      );
  ...
  Widget _buyer(BuildContext context) => Row(
        children: [
          Text(
            'خریدار',
            style:
  ...
  Widget _productsSection(BuildContext context) => Column(
        ...
        children: [
          ...
          const SizedBox(height: 12),
          if (selectedCustomer != null) _productsDiscounts(context),
          const SizedBox(height: 12),
          if (selectedCustomer != null) _invoicePlansAndDiscount(context),
  ...
  void _onCashAmountChange(String t, BuildContext context) {
    ...
    if (t.isEmpty) {
      ...
      try {
        final int _cashAmount = int.parse(t);
